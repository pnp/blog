...
-   You can write custom data providers to connect to any data source.
    ...
    for a blog post next week with more information about custom data
    providers!
