...
{{< image alt="Copy link to a Teams Channel message" src="images/blog/simple-reminders-for-any-teams-channel-or-chat-message/Copy Link.png" >}}
...
2.  One for the **reminder** itself:
    ...
    {{< image alt="The reminder card itself, with links to the original message and chat with message author" src="images/blog/simple-reminders-for-any-teams-channel-or-chat-message/Reminder.png" >}}

3.  Two other cards which are for **catching errors**:
    {{< image alt="Cards reminding users of input error" src="images/blog/simple-reminders-for-any-teams-channel-or-chat-message/Error Cards.png" >}}
...
{{< image alt="The reminder setting card, with an initially invisible container" src="images/blog/simple-reminders-for-any-teams-channel-or-chat-message/Card Source.png" >}}
...
{{< image alt="Action Toggle Visibility.png" src="images/blog/simple-reminders-for-any-teams-channel-or-chat-message/Action Toggle Visibility.png" >}}
...
{{< image alt="The ID and initial visibility of the blue container" src="images/blog/simple-reminders-for-any-teams-channel-or-chat-message/Container ID_annotated.png" >}}
...
{{< image alt="The green container should initially be invisible" src="images/blog/simple-reminders-for-any-teams-channel-or-chat-message/Container ID 2_annotated.png" >}}

Within the containers are also `Columnto house the
fields side by side, just to make it look
nice.

{{< image alt="Use the ColumnSet to place fields and labels (as TextBlock) adjacent to each other" src="images/blog/simple-reminders-for-any-teams-channel-or-chat-message/ColumnSet_annotated.png" >}}
...
{{< image alt="Set some restrictions on the fields, and place TextBlocks above them as labels" src="images/blog/simple-reminders-for-any-teams-channel-or-chat-message/Field_annotated.png" >}}
...
{{< image alt="Input.ChoiceSet for dropdown menu" src="images/blog/simple-reminders-for-any-teams-channel-or-chat-message/What to remind_annotated.png" >}}
...
{{< image alt="For a selected (Teams) message provides a lot of useful dynamic content" src="images/blog/simple-reminders-for-any-teams-channel-or-chat-message/FSM.png" >}}
...
{{< image alt="Some variables are required to hold the time information" src="images/blog/simple-reminders-for-any-teams-channel-or-chat-message/z3019494_0-1620122846412.png" >}}
...
{{< image alt="Check whether the message is in a Chat or Channel, and building the adaptive card to suit the occasion" src="images/blog/simple-reminders-for-any-teams-channel-or-chat-message/z3019494_2-1620123065824.png" >}}
 
...
{{< image alt="Checking to see whether absolute or relative time delay has been inputted" src="images/blog/simple-reminders-for-any-teams-channel-or-chat-message/z3019494_0-1620123654283.png" >}}
 
 
...
{{< image alt="Absolute time calculations: finding out the TotalTimeToDelay" src="images/blog/simple-reminders-for-any-teams-channel-or-chat-message/Absolute Time Processing.png" >}}
...
{{< image alt="Setting the delay" src="images/blog/simple-reminders-for-any-teams-channel-or-chat-message/z3019494_1-1620126674977.png" >}}
